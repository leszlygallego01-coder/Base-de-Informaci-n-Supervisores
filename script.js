...
var ZONA_MAP = {
  'B9':{zona:'BODEGA',depto:'CAUCA'},
  'B05':{zona:'BODEGA VALLE',depto:'VALLE DEL CAUCA'},
  'B10':{zona:'BODEGA VIRTUAL',depto:'BOGOTA'},
  'M03':{zona:'ZONA CAQUETA',depto:'HUILA'},
  'M07':{zona:'ZONA CUNDINAMARCA',depto:'CUNDINAMARCA'},
  'M15':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M16':{zona:'ZONA EJE CAFETERO',depto:'ANTIOQUIA'},
  'M17':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M18':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M20':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M21':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M24':{zona:'CERRADA',depto:'CAUCA'},
  'M27':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M29':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M31':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M32':{zona:'ZONA NARIÑO',depto:'NARIÑO'},
  'M33':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M34':{zona:'ZONA BOYACA',depto:'BOYACA'},
  'M42':{zona:'ZONA EJE CAFETERO',depto:'RISARALDA'},
  'M43':{zona:'ZONA EJE CAFETERO',depto:'CALDAS'},
  'M46':{zona:'ZONA EJE CAFETERO',depto:'QUINDIO'},
  'M61':{zona:'CERRADA',depto:'NARIÑO'},
  'M65':{zona:'ZONA BOYACA',depto:'BOYACA'},
  'M73':{zona:'ZONA BOYACA',depto:'BOYACA'},
  'M75':{zona:'ZONA COSTA NORTE',depto:'GUAJIRA'},
  'M76':{zona:'ZONA BOYACA',depto:'BOYACA'},
  'M77':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M78':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M79':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M82':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M84':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M85':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M87':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M88':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M89':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M90':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M91':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M92':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M93':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M94':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M95':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M96':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'N31':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M100':{zona:'ZONA NARIÑO',depto:'NARIÑO'},
  'M102':{zona:'ZONA NARIÑO',depto:'NARIÑO'},
  'M103':{zona:'ZONA NARIÑO',depto:'NARIÑO'},
  'M104':{zona:'ZONA NARIÑO',depto:'NARIÑO'},
  'M107':{zona:'ZONA EJE CAFETERO',depto:'RISARALDA'},
  'M108':{zona:'ZONA EJE CAFETERO',depto:'RISARALDA'},
  'M111':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M112':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M116':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M117':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M118':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M119':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M120':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M123':{zona:'ZONA BOYACA',depto:'BOYACA'},
  'M124':{zona:'ZONA CAQUETA',depto:'CAQUETA'},
  'M125':{zona:'ZONA CAQUETA',depto:'CAQUETA'},
  'M126':{zona:'ZONA CAQUETA',depto:'CAQUETA'},
  'M130':{zona:'ZONA CAQUETA',depto:'CAQUETA'},
  'M133':{zona:'ZONA CAQUETA',depto:'CAQUETA'},
  'M137':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M138':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M139':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M140':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M141':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M143':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M144':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M145':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M146':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M147':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M148':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M149':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M151':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M152':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M153':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M154':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M155':{zona:'CERRADA',depto:'CERRADA'},
  'M156':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M157':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M158':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M159':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M160':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M161':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M162':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M163':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M164':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M165':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M166':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M167':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M168':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M169':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M170':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M171':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M172':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M173':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M174':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M175':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M176':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M177':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M178':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M179':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M180':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M181':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M182':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M183':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'M184':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M185':{zona:'ZONA CAQUETA',depto:'HUILA'},
  'M188':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M189':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M190':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M193':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M194':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M195':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M197':{zona:'ZONA CAUCA NORTE',depto:'CAUCA'},
  'M209':{zona:'ZONA EJE CAFETERO',depto:'RISARALDA'},
  'M210':{zona:'ZONA EJE CAFETERO',depto:'RISARALDA'},
  'M211':{zona:'ZONA EJE CAFETERO',depto:'RISARALDA'},
  'M212':{zona:'ZONA EJE CAFETERO',depto:'RISARALDA'},
  'M213':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M214':{zona:'ZONA EJE CAFETERO',depto:'RISARALDA'},
  'M217':{zona:'BODEGA VIRTUAL',depto:'VALLE DEL CAUCA'},
  'M218':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M219':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M220':{zona:'CERRADA',depto:'CAUCA'},
  'M223':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M225':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M231':{zona:'ZONA CUNDINAMARCA',depto:'CUNDINAMARCA'},
  'M235':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M239':{zona:'ZONA CUNDINAMARCA',depto:'CUNDINAMARCA'},
  'M240':{zona:'ZONA COSTA NORTE',depto:'GUAJIRA'},
  'M241':{zona:'ZONA COSTA NORTE',depto:'GUAJIRA'},
  'M243':{zona:'BODEGA VIRTUAL',depto:'VALLE DEL CAUCA'},
  'M244':{zona:'ZONA CUNDINAMARCA',depto:'CUNDINAMARCA'},
  'M245':{zona:'ZONA CUNDINAMARCA',depto:'SANTANDER'},
  'M249':{zona:'ZONA VALLE',depto:'VALLE DEL CAUCA'},
  'M250':{zona:'ZONA CUNDINAMARCA',depto:'VAUPES'},
  'M251':{zona:'ZONA CUNDINAMARCA',depto:'CUNDINAMARCA'},
  'M253':{zona:'ZONA CAUCA CENTRO',depto:'CAUCA'},
  'M257':{zona:'LOCAL Y ACTIVOS',depto:'RISARALDA'},
  'M259':{zona:'ZONA CUNDINAMARCA',depto:'CUNDINAMARCA'},
  'M260':{zona:'CERRADA',depto:'CUNDINAMARCA'},
  'M266':{zona:'ZONA EJE CAFETERO',depto:'RISARALDA'},
  'M267':{zona:'ZONA EJE CAFETERO',depto:'RISARALDA'},
  'M268':{zona:'ZONA COSTA NORTE',depto:'GUAJIRA'},
  'M270':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M283':{zona:'ZONA BOYACA',depto:'BOYACA'},
  'M286':{zona:'ZONA BOYACA',depto:'BOYACA'},
  'M291':{zona:'ZONA CAUCA SUR',depto:'CAUCA'},
  'M292':{zona:'ZONA BOYACA',depto:'BOYACA'},
  'M305':{zona:'ZONA CUNDINAMARCA',depto:'CUNDINAMARCA'},
  'M306':{zona:'ZONA CUNDINAMARCA',depto:'CUNDINAMARCA'},
  'M307':{zona:'ZONA CUNDINAMARCA',depto:'CUNDINAMARCA'},
  'M308':{zona:'ZONA CUNDINAMARCA',depto:'CUNDINAMARCA'},
  'M309':{zona:'ZONA CUNDINAMARCA',depto:'CUNDINAMARCA'},
  'M310':{zona:'ZONA BOYACA',depto:'BOYACA'},
  'M311':{zona:'ZONA BOYACA',depto:'BOYACA'},
  'M313':{zona:'ZONA BOYACA',depto:'BOYACA'},
  'M314':{zona:'ZONA BOYACA',depto:'BOYACA'},
  'M337':{zona:'CERRADA',depto:'BOLIVAR'},
  'ST07':{zona:'CERRADA',depto:'CAUCA'},
  'ST28':{zona:'BODEGA VIRTUAL',depto:'VALLE DEL CAUCA'},
  'SM226':{zona:'ZONA TOLIMA',depto:'TOLIMA'},
  'SM256':{zona:'ZONA COSTA NORTE',depto:'GUAJIRA'},
  'SM299':{zona:'ZONA COSTA NORTE',depto:'GUAJIRA'},
  'SM300':{zona:'ZONA COSTA NORTE',depto:'GUAJIRA'},
  'SM301':{zona:'ZONA COSTA NORTE',depto:'GUAJIRA'},
  'SM302':{zona:'ZONA COSTA NORTE',depto:'GUAJIRA'},
  'SM303':{zona:'ZONA COSTA NORTE',depto:'GUAJIRA'},
  'SM304':{zona:'ZONA COSTA NORTE',depto:'GUAJIRA'},
  'URG01':{zona:'BODEGA VIRTUAL',depto:'CAUCA'}
};
/* Extrae el código de bodega (algo tipo M seguido de dígitos) del texto. */
function codigoBodega(bodega){
  var s = up(bodega).trim();
  // Codigo = token inicial: prefijo de letras + digitos (M07, B05, ST28, SM299, URG01, N31...)
  var m = s.match(/^([A-Z]{1,4})\s*-?\s*(\d{1,4})/);
  if(m) return m[1]+m[2];
  // Solo numero al inicio -> asumir prefijo M
  m = s.match(/^(\d{1,4})\b/);
  if(m) return 'M'+m[1];
  return '';
}
...
function lineaTieneSoporte(o){
  // Regla real: columna "Cantidad Soportes" numerica; hay soporte si > 0.
  return toNum(o.soporteRaw) > 0;
}
